...
void
sim_host::register_socket_at(uint16_t port, std::shared_ptr<sim_socket> socket)
{
...
void
sim_host::unregister_socket_at(uint16_t port, std::shared_ptr<sim_socket> socket)
{
...
sim_host::socket_for(uint16_t port)
{
